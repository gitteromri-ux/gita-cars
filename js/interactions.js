// ============================================================
// GITA — Advanced Interactions Layer (interactions.js)
...
(function () {
  ...
  function initPriceCalculator() {
    ...
    const DISCOUNT_USD  = 3000;          // Excel B4 — exclusive GITA discount
...
// ============================================================
// GITA AWARD LAYER — Reveals, Counters, Hero Bigtype, Lenis,
...
(function () {
  ...
  const REG30 = [
    ...
    { t: 'מעקב שיט', d: 'מעקב GPS חי דרך אפליקציית GITA — 24-35 ימי שיט.' },
    ...
    { t: 'ביטוח חובה', d: 'הפקת פוליסת ביטוח חובה דרך יועץ ביטוח GITA.' },
  ...
  const REVIEWS = [
    { name: 'יוסי לוי', mono: 'יל', car: 'מרצדס G63 AMG', stars: 5,
      quote: 'חסכתי ₪915,000 לעומת היבואן הרשמי. השירות של GITA היה ברמה של פרייבט בנקינג. כל שלב מתועד, כל סכום שקוף.' },
    ...
    { name: 'רן אדלר', mono: 'רא', car: 'מרצדס GLS 450d', stars: 5,
      quote: 'GLS 450d במפרט Maybach — לא קיים בארץ דרך היבואן. GITA הביאו אותו תוך 11 שבועות, חסכון של מעל ₪400K.' },
    { name: 'תמר שגיא', mono: 'תש', car: 'טסלה Cybertruck', stars: 5,
      quote: 'הראשונים בישראל עם Cybertruck. GITA טיפלו במובילאיי, רגולציה, רישוי — הכל. עבודה מדויקת ומקצועית.' }
  ];
  ...
  const ADVISORS = [
    ...
    { name: 'Yael Amichai', role: 'דוברות וקשרי קהילה', mono: 'YA',
      bio: 'מובילה את ה־PR והקהילה של GITA. בוגרת אוניברסיטת ת״א, ניסיון בקבוצות יוקרה גלובליות.' },
    ...
    { name: 'נטע פרידמן', role: 'יועצת מימון בכירה', mono: 'נפ',
      bio: 'מובילה את חבילות המימון של GITA לרכבי יוקרה. ניסיון בבנקאות פרטית.' }
  ];
