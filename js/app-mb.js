...
(function () {
  ...
  const WA_KB = {
    ...
    'תהליך': '6 שלבים פשוטים: 1) טופס קצר 60s, 2) פתיחת תיק ₪500 (החזר מלא אם אין התאמה), 3) הצעת רכב תוך זמן קצר עם 3 חלופות, 4) בדיקת 200 נקודות + סרטון, 5) שילוח ימי 8-12 שבועות, 6) רישוי+מסירה בארץ. הכל מסונכרן בפורטל אישי.',
