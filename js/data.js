// ============================================
// GITA CARS — Master Data (from Excel, 1:1)
// USD/ILS = 2.93
// ============================================
...
const CARS = [
  { rank:1, slug:'mercedes-g63-amg', name:'מרצדס G63 AMG', nameEn:'Mercedes-AMG G63',
    ...
    saveUSD:312492, savePct:44, source:'Carzone',
  ...
  { rank:2, slug:'mercedes-gls-450d', name:'מרצדס GLS 450d', nameEn:'Mercedes-Benz GLS 450d',
    ...
    saveUSD:161979, savePct:45, source:'Cartube',
  ...
  { rank:3, slug:'mercedes-g580-eq', name:'מרצדס G580 EQ', nameEn:'Mercedes-Benz G580 with EQ Technology',
    ...
    saveUSD:355206, savePct:61, source:'Carzone',
  ...
  { rank:4, slug:'lucid-air-pure', name:'Lucid Air Pure', nameEn:'Lucid Air Pure (Base)',
    ...
    saveUSD:144238, savePct:53, source:'השוואת מחירים',
  ...
  { rank:5, slug:'mercedes-g500', name:'מרצדס G500', nameEn:'Mercedes-Benz G500',
    ...
    saveUSD:151869, savePct:31, source:'Carzone',
  ...
  { rank:6, slug:'chevy-tahoe-high-country', name:'שברולט טאהו High Country', nameEn:'Chevrolet Tahoe High Country',
    ...
    saveUSD:127634, savePct:48, source:'UMI',
  ...
  { rank:7, slug:'bmw-x7-xdrive40i', name:'BMW X7 xDrive40i', nameEn:'BMW X7 xDrive40i',
    ...
    saveUSD:121570, savePct:40, source:'Cartube',
  ...
  { rank:8, slug:'tesla-model-x-lr', name:'טסלה Model X Long Range', nameEn:'Tesla Model X Long Range',
    ...
    saveUSD:102237, savePct:41, source:'Yad2',
  ...
  { rank:9, slug:'mercedes-s580e', name:'מרצדס S580e PHEV', nameEn:'Mercedes-Benz S580e Plug-in Hybrid',
    ...
    saveUSD:106732, savePct:30, source:'auto.co.il',
  ...
  { rank:10, slug:'ford-bronco-raptor', name:'Ford Bronco Raptor', nameEn:'Ford Bronco Raptor',
    ...
    saveUSD:115839, savePct:42, source:'auto.co.il',
  ...
  { rank:11, slug:'ford-f150-raptor', name:'Ford F-150 Raptor', nameEn:'Ford F-150 Raptor',
    ...
    saveUSD:99259, savePct:43, source:'Carzone',
  ...
  { rank:12, slug:'mercedes-gle-450d', name:'מרצדס GLE 450d', nameEn:'Mercedes-Benz GLE 450d',
    ...
    saveUSD:108810, savePct:41, source:'cmotors.co.il',
  ...
  { rank:13, slug:'tesla-cybertruck-awd', name:'טסלה Cybertruck AWD', nameEn:'Tesla Cybertruck AWD',
    ...
    saveUSD:92131, savePct:39, source:'הגבלות יבוא משוריינת',
    note:'השוואת מחירים – ביקוש חזק',
  ...
  { rank:14, slug:'bmw-x5-xdrive40i', name:'BMW X5 xDrive40i', nameEn:'BMW X5 xDrive40i',
    ...
    saveUSD:85468, savePct:37, source:'cmotors.co.il',
  ...
  { rank:15, slug:'ford-bronco-big-bend', name:'Ford Bronco Big Bend', nameEn:'Ford Bronco Big Bend',
    ...
    saveUSD:59092, savePct:43, source:'iCar',
  ...
  { rank:16, slug:'mustang-gt-v8', name:'Ford Mustang GT V8', nameEn:'Ford Mustang GT (V8)',
    ...
    saveUSD:59147, savePct:41, source:'auto.co.il',
  ...
  { rank:17, slug:'kia-ev9-rwd', name:'Kia EV9 RWD', nameEn:'Kia EV9 RWD',
    ...
    saveUSD:44947, savePct:31, source:'Kia Israel',
  ...
  { rank:18, slug:'rivian-r1s-dual', name:'Rivian R1S Dual', nameEn:'Rivian R1S Dual-Motor',
    ...
    saveUSD:48443, savePct:26, source:'השוואת מחירים',
  ...
  { rank:19, slug:'jeep-wrangler-sport', name:'Jeep Wrangler Unlimited Sport S', nameEn:'Jeep Wrangler Unlimited Sport S',
    ...
    saveUSD:44363, savePct:36, source:'Yad2',
  ...
  { rank:20, slug:'chevy-traverse-z71', name:'שברולט Traverse Z71', nameEn:'Chevrolet Traverse Z71',
    ...
    saveUSD:32175, savePct:28, source:'UMI',
...
const PROCESS_STEPS = [
  ...
  { phase:2, label:'הצעה', title:'תוך ~זמן קצר – הצעה דרך הפורטל', desc:'מציגים לכם את הרכב והמחיר המלא בפורטל אישי מאובטח. כולל כל העמלות, חישוב סופי, ציר זמן ומסמכי הרכב. הזדרזו – הרכבים הטובים נחטפים מהר.', icon:'offer', side:'right'},
  ...
  { phase:3, label:'שילוח', title:'הטענה לאוניית משא וטרנזיט', desc:'הרכב מועלה לאוניית משא לישראל. מקבלים מועד מדויק להגעה (בממוצע זמן קצוב), שטר מטען (Bill of Lading) ופוליסת ביטוח מלאה.', icon:'ship', side:'right'},
...
// ============================================
const FAQ = [
  { q:'איך מתחילים? מה השלב הראשון?', a:'בוחרים רכב מהקטלוג באתר ומקבלים אומדן ראשוני מיידי. לאחר מכן פותחים תיק עם מקדמה סמלית של ₪500 ושולחים צילום ת.ז ורישיון נהיגה. תוך זמן קצר הצוות סורק את כל שותפי הרכב בארה״ב, מבצע תחרות ביניהם ומחזיר הצעת מחיר מלאה דרך פורטל הלקוחות.' },
  ...
  { q:'כמה זמן לוקח כל התהליך?', a:'בממוצע 60-90 יום מההזמנה ועד מסירת המפתחות. הפירוט: 1-3 ימים לבחירה והזמנה, עד זמן קצר להצעה סופית, 7-14 ימי איסוף ובדיקה בארה״ב, 38 ימי שיט עד אשדוד, 14-21 יום מכס + סטנדרטיזציה + רישוי. כל לוח הזמנים נעקב בפורטל הלקוחות.' },
